...
public class InstanceLoadTest
{
	...
	public void RepeatedAttemptToLoadMissingPrefab_ShouldNotThrowException()
	{
		...
		using var nestedPrefab = SceneTests.Helpers.RegisterPrefabFromJson( nestedPrefabPath,
		...
		using var outerPrefab = SceneTests.Helpers.RegisterPrefabFromJson( outerPrefabPath,
