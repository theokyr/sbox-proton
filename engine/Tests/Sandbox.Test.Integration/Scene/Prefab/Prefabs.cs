...
public class PrefabTest
{
	...
	public void Variables()
	{
		...
		using var tempPrefab = SceneTests.Helpers.RegisterPrefabFromJson( "runtime_variable_test.prefab", prefabScene.Serialize().ToJsonString() );
		...
		// Make sure serializing variables works
		{
			...
			var importedScene = SceneUtility.GetPrefabScene( imported );
