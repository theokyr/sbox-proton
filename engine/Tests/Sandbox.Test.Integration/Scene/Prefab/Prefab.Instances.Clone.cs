...
public class InstanceCloneTest
{
	...
	public void CloneOutermostPrefabInstanceInRegularScene()
	{
		...
		using var prefab = SceneTests.Helpers.RegisterPrefabFromJson( prefabLocation, _basicPrefabSource );
	...
	public void ClonePrefabInstanceInPrefabScene()
	{
		...
		using var outerPrefab = SceneTests.Helpers.RegisterPrefabFromJson( outerPrefabLocation, _outerPrefabSource );
	...
	public void CloneRegularGameObjectContainingNestedPrefabInstance()
	{
		...
		// Create outer prefab
		using var outerPrefab = SceneTests.Helpers.RegisterPrefabFromJson( outerPrefabLocation, _outerPrefabWithRegularGOSource );
		var outerPrefabFile = ResourceLibrary.Get<PrefabFile>( outerPrefabLocation );
		var outerPrefabScene = SceneUtility.GetPrefabScene( outerPrefabFile );
