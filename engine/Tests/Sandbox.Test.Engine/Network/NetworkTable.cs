...
public class NetworkTableTest
{
	...
	public void SetValue()
	{
		...
		table.Register( 3, new Sandbox.Network.NetworkTable.Entry { GetValue = () => value, SetValue = v => value = (bool)v } );
		table.SetValue( 3, true );

		Assert.IsTrue( value );
		Assert.AreEqual( true, table.GetValue( 3 ) );
	}
